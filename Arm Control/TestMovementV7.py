...
#
        ...
        if BASE_L_DOWN <= thetaBaseN[1] <= BASE_L_UP :
            ...
            if P_counter == CLEARANCE:
                ...
                unrounded_final_forearm_TO_wrist_Speed = calcSpeeds(firstWrist_P, finalWrist_P,firstForearm_P,finalForearm_P)
            ...
            # below will assign the first set of motor angles for movement for the push/pull motion
                ...
                unrounded_first_forearm_TO_wrist_Speed = calcSpeeds(firstWrist_P,finalWrist,firstForearm_P,finalForearm)
